  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
        {/* Map embed */}
        <div className="overflow-hidden rounded-2xl border border-slate-200 shadow-sm dark:border-stone-800">
          <iframe
        ...
        <div className="mt-8 grid gap-6 sm:grid-cols-2">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-900">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-stone-800 dark:bg-stone-900">
            <h2 className="text-lg font-bold text-stone-900 dark:text-white">Lieferzonen</h2>
            <div className="mt-3 space-y-4 text-sm">
              <div>
                <p className="font-semibold text-stone-900 dark:text-white">Zone 1 — ab CHF 20</p>
                <p className="text-stone-600 dark:text-stone-400">Erlenbach, Küsnacht, Herrliberg</p>
              </div>
              <div>
                <p className="font-semibold text-stone-900 dark:text-white">Zone 2 — ab CHF 30</p>
                <p className="text-stone-600 dark:text-stone-400">Zollikon, Küsnacht, Itschnach, Herrliberg, Wetzwil, Feldmeilen</p>
              </div>
            </div>
          </div>
        </div>
